FROM alpine:latest
LABEL PROJECT="alpine_bash_tomcat" \
      VERSION="1.0"             \
      AUTHOR="lishuaiqi"              \
      COMPANY="Shanghai HEADING Information Engineering Co., Ltd."
MAINTAINER lishuaiqi "lishuaiqi@hd123.com"
...
# apk del curl ca-certificates && \
 mv jdk1.${JAVA_VERSION_MAJOR}.0_${JAVA_VERSION_MINOR}/jre /jre && mv jdk1.${JAVA_VERSION_MAJOR}.0_${JAVA_VERSION_MINOR}/include/linux /jre/linux && \
#  rm /jre/bin/jjs && \
  rm /jre/bin/keytool && \
  rm /jre/bin/orbd && \
  rm /jre/bin/pack200 && \
